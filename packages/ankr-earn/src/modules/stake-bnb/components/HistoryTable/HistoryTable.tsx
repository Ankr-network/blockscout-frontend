...
export const HistoryTable = ({
  ...
  const switcherCaptions = useLocaleMemo(
    () => [
      ...
      {
        label: t('stake-bnb-dashboard.switcher.pending-title'),
      },
    ],
    [],
  );
  ...
  const headerCaptions = useLocaleMemo(
    () => [
      ...
      {
        label: t('stake-bnb-dashboard.column.tx-hash'),
      },
      {
        label: t('stake-bnb-dashboard.column.tx-type'),
      },
      {
        align: 'right',
        label: t('stake-bnb-dashboard.column.amount'),
      },
    ],
    [],
  );
