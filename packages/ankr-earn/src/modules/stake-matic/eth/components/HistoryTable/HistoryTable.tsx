...
export const HistoryTable = ({
  ...
  const switcherCaptions = useLocaleMemo(
    () => [
      {
        label: t('stake-matic-dashboard.switcher.completed-title'),
      },
      {
        label: t('stake-matic-dashboard.switcher.pending-title'),
      },
    ],
    [],
  );
  ...
  const headerCaptions = useLocaleMemo(
    () => [
      {
        label: t('stake-matic-dashboard.column.tx-date'),
      },
      {
        label: t('stake-matic-dashboard.column.tx-hash'),
      },
      {
        label: t('stake-matic-dashboard.column.tx-type'),
      },
      {
        align: 'right',
        label: t('stake-matic-dashboard.column.amount'),
      },
    ],
    [],
  );
