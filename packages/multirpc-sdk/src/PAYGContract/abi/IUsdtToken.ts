...
export type ContractContext = Web3ContractContext<
  IUsdtToken,
  IUsdtTokenMethodNames,
  IUsdtTokenEventsContext,
  IUsdtTokenEvents
>;
export type IUsdtTokenEvents = 'Approval' | 'OwnershipTransferred' | 'Transfer';
export interface IUsdtTokenEventsContext {
  Approval(
    parameters: {
...
export type IUsdtTokenMethodNames =
  | 'new'
  | 'allowance'
  | 'approve'
  | 'balanceOf'
...
export interface IUsdtToken {
   ...
   * @param initialSupply_ Type: uint256, Indexed: false
   */
  'new'(
    name_: string,
    symbol_: string,
    decimals_: string | number,
    initialSupply_: string,
  ): MethodReturnContext;
  /**
   * Payable: false
   * Constant: true
