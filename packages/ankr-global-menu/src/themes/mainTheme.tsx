...
import { darkPalette, Themes } from '@ankr.com/ui';

export const FONTS = {
  primary: ['Inter', 'Arial', 'sans-serif'].join(','),
  secondary: ['Inter', 'Arial', 'sans-serif'].join(','),
};
...
export const getDefaultTheme = (themes: Themes) => {
  return createTheme({
    spacing: 8,
    palette: themes === Themes.light ? PALETTE : darkPalette,
