...
export const metaTranslation = {
  [Locale.en]: {
    '/': {
      title: 'Free Blockchain RPC Endpoints for 45+ Networks: Ankr Chainlist',
      description:
        "Access 45+ blockchains via Ankr Chainlist's RPC endpoints. Optimize crypto projects seamlessly. Start testing our RPC now for free!",
