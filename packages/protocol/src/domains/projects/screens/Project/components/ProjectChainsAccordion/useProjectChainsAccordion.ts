...
export const useProjectChainsAccordion = ({
  ...
  const lastHourAggegatedRequests = useAppSelector(state =>
  ...
  const requestsData = useMemo(() => {
    return timeframe === Timeframe.Hour
      ? lastHourAggegatedRequests
      : lastDayAggregatedRequests;
  }, [timeframe, lastHourAggegatedRequests, lastDayAggregatedRequests]);
